...
- SINGLE QUERY ONLY: Return exactly one simple query string. Do not use pipes, OR syntax, or multiple variants.
...
2. EXPANSION: Use the most relevant in-scope terms to refine one query.
...
- Do NOT include the pipe symbol "|" or any multi-query formatting.
- Do not include query "-" in the query.
